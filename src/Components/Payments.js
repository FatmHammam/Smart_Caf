...
function Payments() {
  const data = [
    { name: 'Yahia Mohammed', status: 'Missing', id: '1756'},
    { name: 'Mohamed Gamal', status: 'Missing', id: '25566' },
    { name: 'Fatma Refaat', status: 'Progress', id: '12345' },
    { name: 'Menna Gamal', status: 'Completed', id: '1756' },
    ...
    { name: 'Hamdy Elmarghany', status: 'Pending', id: '12345'  },
  ];
  const headers = ["#", "Request No.", "Client", "Services", "Request Date", "DUE Date", "Amount", "Status"];
  const statuses = {
    Pending: '#FFA800',
    Completed: '#348A52',
    Progress: '#006FAD',
